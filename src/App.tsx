        ...
        <aside className='w-80 space-y-4'>
          <form className='space-y-4'>
            ...
            <div className='space-y-2'>
              ...
              <Textarea className='h-20 leading-relaxed resize-none' id='transcription_prompt' placeholder='Inclua palavras-chave mencionadas no vídeo separadas por vírgula (,)' />
            </div>
